...
def load_wildfire() -> pd.DataFrame:
    ...
    numeric_cols = [
        "acres_burned_millions", "fs_treatment_millions", "interior_treatment_millions",
...
def main():
    wf = load_wildfire()
    vpd = load_vpd()
    merged = wf.merge(vpd, on="year", how="left")
    ...
    windows = [
        ...
        ("2010-2025 w/ VPD", merged, ["acres_burned_millions", "dsci_avg", "dsci_west_avg", "vpd_kpa"], 2010, 2025),
        ("2018-2024 prevention overlap", merged, ["acres_burned_millions", "interior_treatment_millions", "dsci_avg", "dsci_west_avg", "vpd_kpa"], 2018, 2024),
        ("2023-2025 FS overlap", merged, ["acres_burned_millions", "fs_treatment_millions", "dsci_avg", "dsci_west_avg", "vpd_kpa"], 2023, 2025),
    ]
    ...
    matrix_cols = ["acres_burned_millions", "dsci_avg", "dsci_west_avg", "vpd_kpa"]
