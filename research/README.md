...
| [`fact-check-log.md`](fact-check-log.md) | Pass/fail audit log per claim ID |

## Using the claim registry

1. Before editing copy on `index.html` or `explore.html`, check whether the statement already has a claim ID in `claims.md`.
